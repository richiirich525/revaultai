...
function FAQPage({ setPage }) {
  const faqs = [
    ...
    {
      q: "Can creators earn money from views?",
      a: "Yes — this is coming after launch. Alongside selling premium prompts, creators will be able to earn a share of ad revenue generated by their work, similar to YouTube. Once your approved creations reach a minimum view threshold, they become eligible to earn from ads as they're viewed. The exact threshold and revenue share will be published when the program goes live."
    },
    {
  ...
  return (
    <div className="page">
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "80px 48px", textAlign: "center" }}>
        <div style={{ display: "inline-block", border: "1px solid var(--accent)", borderRadius: 4, padding: "4px 16px", fontFamily: "'DM Mono', monospace", fontSize: 9, letterSpacing: "0.2em", color: "var(--accent)", textTransform: "uppercase", marginBottom: 16 }}>Coming After Launch</div>
        <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 40, fontWeight: 300, color: "var(--text)", marginBottom: 16, lineHeight: 1.1 }}>Earn from your views.</div>
        <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 12, color: "var(--muted)", lineHeight: 1.9 }}>Beyond premium prompts, creators will be able to earn a share of ad revenue generated by their work — much like YouTube. Once your approved creations pass a minimum view threshold, they become eligible to earn from ads as they are watched. Full details, including the threshold and revenue share, will be announced when the program launches.</div>
      </div>
